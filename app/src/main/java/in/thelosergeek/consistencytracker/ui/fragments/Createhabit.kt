...
import kotlinx.android.synthetic.main.fragment_createhabit.*
import kotlinx.coroutines.InternalCoroutinesApi
import java.util.*

class createhabit : Fragment(R.layout.fragment_createhabit),
    ...
    private fun addHabitToDB() {
        ...
        if (!(title.isEmpty() || description.isEmpty() || timeStamp.isEmpty() || drawableSelected == 0)) {
            ...
            findNavController().navigate(R.id.action_createhabit_to_consistentFragment)
        } else {
    ...
    override fun onTimeSet(TimePicker: TimePicker?, p1: Int, p2: Int) {
        ...
        cleanTime = DateCalculation.cleanTime(p1, p2)
    ...
    override fun onDateSet(p0: DatePicker?, yearX: Int, monthX: Int, dayX: Int) {
        ...
        cleanDate = DateCalculation.cleanDate(dayX, monthX, yearX)
